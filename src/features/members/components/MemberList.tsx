...
export default function MemberList({ members, canWrite, onEdit, onToggleActive }: MemberListProps) {
  if (members.length === 0) {
  ...
  function renderActions(member: MemberDto) {
    ...
    return <MemberActionsMenu member={member} onEdit={onEdit} onToggleActive={onToggleActive} />
  }
